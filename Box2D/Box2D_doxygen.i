...
%feature("docstring") b2Fixture::SetFilterData "Set the contact filtering data. This will not update contacts until the next time step when either parent body is active and awake.";
...
%feature("docstring") b2LineJoint "A line joint. This joint provides two degrees of freedom: translation along an axis fixed in body1 and rotation in the plane. You can use a joint limit to restrict the range of motion and a joint motor to drive the motion or to model joint friction.";
...
%feature("docstring") b2LineJoint::SetMaxMotorForce "Set/Get the maximum motor force, usually in N.";

%feature("docstring") b2LineJoint::GetMotorForce "Get the current motor force given the inverse time step, usually in N.";
...
// File: b2_distance_8h.xml
%feature("docstring") b2Distance "Compute the closest points between two shapes. Supports any combination of:  b2CircleShape,  b2PolygonShape,  b2EdgeShape. The simplex cache is input/output. On the first call set b2SimplexCache.count to zero.";


// File: b2_time_of_impact_8cpp.xml
